...
def "main build image" [
    ...
    docker image build --tag $"ghcr.io/sandbox43210/idp-full-app:latest" .
    docker image tag $"ghcr.io/sandbox43210/idp-full-app:latest" $"ghcr.io/sandbox43210/idp-full-app:($tag)"
    if $push {
        docker image push $"ghcr.io/sandbox43210/idp-full-app:latest"
        docker image push $"ghcr.io/sandbox43210/idp-full-app:($tag)"
    }
}
# Updates the claim
